# Generated by Django 6.0.5 on 2026-05-09 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('member', 'Member'), ('librarian', 'Librarian')], default='member', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('borrowing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='penalties', to='library.borrowing')),
